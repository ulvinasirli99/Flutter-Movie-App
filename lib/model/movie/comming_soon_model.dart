...
ComingSoonModel comingSoonModelFromJson(String str) => ComingSoonModel.fromJson(json.decode(str));

String comingSoonModelToJson(ComingSoonModel data) => json.encode(data.toJson());
